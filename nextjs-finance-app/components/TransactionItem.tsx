...
export const TransactionItem = ({ id, type, category, description, amount, onRemoved }) => {
  ...
  return (
    <div className="w-full flex items-center">
      ...
      <div className="min-w-37.5 items-center hidden md:flex">{category && <div className="rounded-md text-xs bg-gray-700 dark:bg-gray-100 text-gray-100 dark:text-black px-2 py-0.5">{category}</div>}</div>
